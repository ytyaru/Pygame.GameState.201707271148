...
#        self.__max_len_goal = max([len(s) for s in self.__ghostleg.Goals])
#        self.__max_len_goal = None
...
#    @property
#    def GoalStrMaxLen(self):
#        self.__max_len_goal = max([len(s) for s in self.__ghostleg.Goals])
#        return self.__max_len_goal
    @property
